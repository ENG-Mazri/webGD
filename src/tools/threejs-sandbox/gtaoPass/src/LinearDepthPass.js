import {ShaderLib, FrontSide, BackSide, Vector3, Plane} from 'three';
import {ShaderReplacement} from '../../shader-replacement/src';
		...
		super({
			...
			fragmentShader: /* glsl */`
				...
				void main() {
				    ...
				    //if element state is Inactive
				    if(state > -3.1 && state < -2.9)
				    {
