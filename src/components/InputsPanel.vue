<template>
    <div class='panel'>
        ...
        <n-collapse class='panel-collapse'> <!-- Function -->
            ...
            <n-collapse-item v-if="showOutputs" class="parent_panels" title="Outputs" name="2" style="margin: 0px 2px;"><!-- Outputs -->
                <template #arrow>
                    <n-icon>
                        <outputIcon/>
                    </n-icon>
...
import {OptionsOutline as optionsIcon ,
        ...
        ChatboxSharp, Refresh as refreshIcon
...
export default defineComponent({
    components: {
        ...
        clearIcon, OutputsPanel, variableIcon, goalIcon, locateIcon, refreshIcon
    },
    props: ['hasStudy'],
    data(){
        return {
    ...
    async mounted() {
        ...
        if(gd_resultsByEvaluator) this.showOutputs = true;
...
#inputs_divider > .n-divider__line{
